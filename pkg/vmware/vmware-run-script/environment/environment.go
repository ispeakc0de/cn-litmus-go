...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = common.Getenv("EXPERIMENT_NAME", "vmware-run-script")
	...
	experimentDetails.SourceDir = common.Getenv("SOURCE_DIRECTORY", "/tmp/")
	experimentDetails.DestinationDir = common.Getenv("DESTINATION_DIRECTORY", "/tmp/")
	experimentDetails.ScriptFileName = common.Getenv("SCRIPT_FILE_NAME", "chaos-script.sh")
