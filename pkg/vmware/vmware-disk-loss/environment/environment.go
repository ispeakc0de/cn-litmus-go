...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = common.Getenv("EXPERIMENT_NAME", "vmware-disk-loss")
	...
	experimentDetails.AppVMMoids = common.Getenv("APP_VM_MOIDS", "")
	experimentDetails.DiskIds = common.Getenv("VIRTUAL_DISK_IDS", "")
