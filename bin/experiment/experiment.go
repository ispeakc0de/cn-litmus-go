...
import (
	...
	vmwareHostReboot "github.com/chaosnative/litmus-go/experiments/vmware/vmware-host-reboot/experiment"
...
func main() {
	...
	case "vmware-host-reboot":
		vmwareHostReboot.VMWareHostReboot(clients)
